...
_SESSION = _descriptor.Descriptor(
  name='Session',
  full_name='protos.Session',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='protos.Session.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='uid', full_name='protos.Session.uid', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='protos.Session.data', index=2,
