...
inline ::protos::RPCType Request::_internal_type() const {
  return static_cast< ::protos::RPCType >(_impl_.type_);
}
...
inline const ::protos::Session& Request::_internal_session() const {
  const ::protos::Session* p = _impl_.session_;
...
inline ::protos::Session* Request::release_session() {
  ...
  ::protos::Session* temp = _impl_.session_;
...
inline const ::protos::Msg& Request::_internal_msg() const {
  const ::protos::Msg* p = _impl_.msg_;
...
void Request::set_frontendid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.frontendid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Request::set_allocated_frontendid(std::string* frontendid) {
  ...
  _impl_.frontendid_.SetAllocated(frontendid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.frontendid_.IsDefault()) {
