...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_docmsg_2eproto_metadata_getter(int index);
namespace protos {
class DocMsg;
...
class DocMsg PROTOBUF_FINAL :
 ...
 public:
  ...
  inline DocMsg* New() const final {
    return CreateMaybeMessage<DocMsg>(nullptr);
  }

  DocMsg* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_docmsg_2eproto_metadata_getter(kIndexInFileMessages);
  }
