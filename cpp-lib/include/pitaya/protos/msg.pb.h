...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Msg::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Msg::id() const {
  // @@protoc_insertion_point(field_get:protos.Msg.id)
  return _internal_id();
}
inline void Msg::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  id_ = value;
}
inline void Msg::set_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
...
inline void Msg::set_data(const void* value,
    size_t size) {
