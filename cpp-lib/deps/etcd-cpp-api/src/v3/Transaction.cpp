 ...
 * get key, delete
 */
void etcdv3::Transaction::setup_delete_failure_operation(std::string const &key, std::string const &range_end, bool const recursive)
{
  std::unique_ptr<RangeRequest> get_request(new RangeRequest());
 ...
 * get key, delete
 */
void etcdv3::Transaction::setup_delete_sequence(std::string const &key, std::string const &range_end, bool const recursive)
{
  std::unique_ptr<DeleteRangeRequest> del_request(new DeleteRangeRequest());
  del_request->set_key(key);
