...
inline std::string* Request::release_val() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = val_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void Request::set_prevvalue(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000008u;
 prevvalue_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Request::_internal_set_prevvalue(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  prevvalue_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Request::_internal_mutable_prevvalue() {
  _has_bits_[0] |= 0x00000008u;
  return prevvalue_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Request::release_prevvalue() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  auto* p = prevvalue_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (prevvalue_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
