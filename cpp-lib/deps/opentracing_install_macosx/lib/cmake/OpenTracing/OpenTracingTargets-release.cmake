...
set_target_properties(OpenTracing::opentracing PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopentracing.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopentracing.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS OpenTracing::opentracing )
list(APPEND _IMPORT_CHECK_FILES_FOR_OpenTracing::opentracing "${_IMPORT_PREFIX}/lib/libopentracing.dylib" )
...
set_target_properties(OpenTracing::opentracing_mocktracer PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopentracing_mocktracer.1.5.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopentracing_mocktracer.1.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS OpenTracing::opentracing_mocktracer )
list(APPEND _IMPORT_CHECK_FILES_FOR_OpenTracing::opentracing_mocktracer "${_IMPORT_PREFIX}/lib/libopentracing_mocktracer.1.5.1.dylib" )
